...
// // Agregar un evento al contenedor
...
//         event.target.classList.toggle("highlight"); // Agregamos o quitamos la clase "highlight" al elemento clickeado
//     });
// });

const list = document.querySelector("ul");
list.addEventListener("click", (event) => {
    event.target.closest("li").classList.toggle("highlight"); // Agregamos o quitamos la clase "highlight" al elemento clickeado
});